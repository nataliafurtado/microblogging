...
class TeddyController = TeddyControllerBase with _$TeddyController;

abstract class TeddyControllerBase extends FlareControls
    with Store, ChangeNotifier {
  final BuildContext context;
  TeddyControllerBase(this.context);
